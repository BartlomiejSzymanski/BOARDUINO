...
class Data:
    def __init__(self):
        self.names = {[
            ["Andrzej", 'W'], ["Leszek", 'W'], ["Anita", 'W'], ["Iwona", 'W'], ["Aniela", 'W'], ["Bogusław", 'P'], ["Jarosław", 'P'], ["Janusz", 'P'], ["Kinga", 'P'],
            ["Eugeniusz", 'P'], ["Weronika", 'W'], ["Jeremiasz", 'W'], ["Ignacy", 'W'], ["Horacy", 'W'], ["Ewa", 'P'], ["Ilona", 'P'], ["Adrianna", 'P'], ["Sasza", 'P'],
            ["Misza", 'P'], ["Zofia", 'P']
        ]
        }
        self.fields = {
